...
exports.emailContent = exports.emailObjSend = void 0;
exports.emailObjSend = {
...
const emailContent = (qrCodeImage, accessCode) => {
    const subject = "Bem-vindo ao Couple Diary!";
    const text = "Olá, bem-vindo ao Couple Diary! Estamos felizes em tê-lo conosco.";
    const html = `
        <html>
          <body>
